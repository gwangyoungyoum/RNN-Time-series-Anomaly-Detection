...
def print_output(data_source):
    ...
    for i in range(0, data_source.size(0) - 1, args.bptt):
        ...
        output, hidden = model(data, hidden)
        if args.cuda:
            topv, topi = output.data.cpu().topk(1)
        else:
            topv, topi = output.data.topk(1)
        # print topv,  topi
        # print topi[0][0][0]
        print corpus.dictionary.idx2word[topi[0][0][0]]
...
print('=' * 89)
print('| End of training | test loss {:5.24} | test ppl {:8.4f}'.format(
