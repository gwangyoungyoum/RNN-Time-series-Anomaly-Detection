...
parser.add_argument('--prediction_window_size', type=int, default=50,
...
model = model.RNNPredictor(rnn_type = args.model, enc_inp_size=3, rnn_inp_size = args.emsize, rnn_hid_size = args.nhid,
                           dec_out_size=args.prediction_window_size,nlayers = args.nlayers, dropout = args.dropout, tie_weights= args.tied)
...
def get_batch(source, i, window_size,evaluation=False):
